			...
			<div class="col-12">
				<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
		                    	<a href="itemdetail.php?id=<?= $di_id ?>"><img src="<?= $di_photo ?>" class="img-fluid"></a>
				...
				<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
		            <div class="MultiCarousel-inner">
		            	...
		            	<?php 
		            		...
		            		$sql = 'SELECT * FROM items ORDER BY created_up DESC LIMIT 8';
		            		$stmt = $conn->prepare($sql);
		            		$stmt->execute();
		                ...
		                <div class="item">
		                    <div class="pad15">
		                    	<a href="itemdetail.php?id=<?= $di_id ?>"><img src="<?= $sa_photo ?>" class="img-fluid"></a>
			...
			<div class="col-12">
				<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
		                    	<a href="itemdetail.php"><img src="<?= $ra_photo ?>" class="img-fluid"></a>
