            ...
            <div class="col-xl-6 col-lg-6 col-md-4 col-sm-2 col-2 order-xl-2 order-lg-2 order-md-3 order-sm-3 order-3">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-10">
                        ...
                        <a href="login.php" class="d-xl-block d-lg-block d-md-block d-none  text-decoration-none loginLink float-right" data-toggle="dropdown" role="button"> 
    ...
    <div class="container subNav d-xl-block d-lg-block d-none my-3">
        <div class="row align-items-center">
            <div class="col-3 align-items-center">
                <p class="d-inline pr-3"> Shops By </p>
            ...
            <div class="col-3">
                <div class="hov-dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
                        ...
                        <a class="dropdown-item" href="subcategory1.php?mid=<?= $id ?>"><?= $name ?></a>
                        <!-- <div class="dropdown-divider"></div>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <div class="mt-3">
            ...
            <div class="collapse sidebardropdown_container_category mt-3" id="account">
                ...
                <a href="orderhistory" class="py-2"> Order History </a>
                <a href="changepassword.php" class="py-2"> Change Password </a>
