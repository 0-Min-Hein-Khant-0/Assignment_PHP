				...
				<form action="signup.php" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input class="form-control py-4" id="inputConfirmPassword" type="password" placeholder="Confirm password" name="confirmpssword" />
                    ...
                    <div class="form-group">
		      		...
		      		<div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
		        		...
		        		<button type="submit" class="btn btn-secondary mainfullbtncolor btn-block" id="btnSubmit"> Create Account </button>
		      		</div>
		  		</form>
